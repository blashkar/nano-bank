...
from coo.api import create_app
...
def test_health_reports_each_probe_and_never_500s():
    ...
    assert checks["operations_mcp"] is False
    assert checks["qdrant"] is False           # raising probe -> False, not 500
