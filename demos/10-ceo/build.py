...
BEATS = [
    {
        ...
        "message": "The board just ruled on recurring e-Transfers: PHASE a capped pilot "
                   ...
                   "open-ended launch. The binding condition, per the COO's operational "
                   "finding: under a concentrated send surge, the Interac notification "
                   "outbox inside bank-api itself (not a separate deployed service — your "
                   "platform tools won't see it as its own component) backed up to 100 "
                   "undelivered items before a manual flush cleared it. DIRECT the CTO: "
                   "start the pilot's first piece of implementation — delegate the pilot's "
